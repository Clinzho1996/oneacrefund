...
export function SiteDataTable<TData, TValue>({
	columns,
	data,
	...
	const handleAddSite = async (event: React.FormEvent) => {
		...
		try {
			...
			if (!name || !selectedStateId || !selectedDistrictId || !selectedPodId) {
			...
			<Modal
				...
				<div className="bg-white py-5 rounded-lg transition-transform ease-in-out ">
					...
					<div className="mt-3  pt-2">
						...
						<p className="text-xs text-primary-6 mt-2 font-inter">Site Name</p>
						<Input
							type="text"
							value={name}
